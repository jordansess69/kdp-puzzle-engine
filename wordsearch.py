#!/usr/bin/env python3
"""
wordsearch.py — code-generated, print-ready LARGE PRINT word search book for Amazon KDP.

Swap the --themes JSON and you have a brand-new book in a new niche. That's the engine:
unlimited unique puzzle books, generated by code, at a quality hand-makers can't match on volume.

RUN WITH /usr/bin/python3 (it has reportlab + PIL; brew python3.14 does not):

    /usr/bin/python3 wordsearch.py --themes themes/nature.json --out out/nature_v1.pdf

Output: a 8.5x11 print-ready interior PDF — front matter, large-print puzzles, full solutions.
KDP needs a separate cover (use KDP's free Cover Creator, or generate one later).
"""
